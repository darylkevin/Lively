  ...
  return (
    <div className="mx-auto h-[70vh] md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl">
      <section className="grid h-full grid-cols-4 md:grid-cols-3">
        <div className="col-span-3 mx-auto flex flex-col justify-center max-md:px-4 md:col-span-2 md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl">
