...
const NavBar = ({
  ...
  return (
    <>
      ...
      >
        <header className="mx-auto flex items-center justify-between gap-8 max-md:p-8 md:max-w-screen-md md:pb-8 md:pt-6 lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl">
