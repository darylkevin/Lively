          ...
          <div className="flex flex-col justify-between h-full gap-8">
            <header className="flex justify-between">
              ...
              <div className="flex">
                ...
                {navs.map((nav, i) => (
                  <Link key={nav.href} href={nav.href} className={`${pathname === nav.href && 'scale-110 -translate-y-2 translate-x-2'} -mx-3 hover:scale-110 hover:-translate-y-2 hover:translate-x-2 hover:cursor-pointer transition-all duration-500 relative`}>
